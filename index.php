    ...
    <style>
        ...
        * {
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 .2rem rgba(138, 164, 255, .25);
        }
    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <label for="inputText" class="form-label fw-semibold text-primary">1. Paste your inputs</label>
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-3 align-items-center">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <label class="form-check-label small text-light" for="stripCodeFences">Strip markdown fences</label>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <input class="form-check-input" type="checkbox" id="normalisePaths" checked>
                                <label class="form-check-label small text-light" for="normalisePaths">Normalise paths</label>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <input class="form-check-input" type="checkbox" id="uniqueOnly" checked>
                                <label class="form-check-label small text-light" for="uniqueOnly">De‑duplicate</label>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold text-primary" for="assumeAs">2. Assume unidentified items are</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold text-primary" for="outputBucket">3. Output bucket</label>
            ...
            <div class="col-12 col-lg-4">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="fw-semibold mb-2 text-primary">Buckets overview</div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <label for="outputText" class="form-label fw-semibold text-primary">4. Output summary.json</label>
        ...
        inputEl.addEventListener('input', () => {
            ...
            debounce = setTimeout(() => {
                ...
                const cleaned = objs.length ? objs.reduce((acc, o) => {
                    ...
                    for (const k of BUCKETS)
                        if (Array.isArray(o[k]))
                            for (const it of o[k]) tmp = tmp.replaceAll(String(it), "");
                    return tmp;
                }, text) : text;
